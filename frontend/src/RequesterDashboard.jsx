  ...
  return (
    <div className="min-h-screen bg-[#f0f4f8]">
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-12 py-10">
          ...
          <div>
            ...
            <div style={{
              ...
              <div style={{ padding: '28px' }}>
                {submitSuccess && (
                  <div style={{
                    backgroundColor: '#dcfce7', border: '1px solid #86efac', borderRadius: '10px',
                  ...
                  return (
                    <div key={ticket.id} onClick={() => openDetail(ticket.id)} style={{
                      ...
                      <div style={{ display: 'flex', alignItems: 'center', gap: '14px' }}>
                        <div style={{
                          width: '38px', height: '38px', borderRadius: '10px', backgroundColor: st.bg,
        ...
        {view === 'detail' && (
          <div>
            <button onClick={() => setView('my-tickets')} style={{
              display: 'flex', alignItems: 'center', gap: '6px',
              background: 'none', border: 'none', color: '#64748b', fontSize: '13px', cursor: 'pointer',
              fontWeight: '600', marginBottom: '24px', padding: 0
            }}>
            ...
            {isLoadingDetail ? (
              <div style={{
                textAlign: 'center', padding: '80px', backgroundColor: '#fff',
              ...
              return (
                <div style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
                  ...
                  <div style={{
                    ...
                    <div style={{ padding: '28px', display: 'flex', flexDirection: 'column', gap: '20px' }}>
                      ...
                      <div>
                        ...
                        `}</style>
                        <div style={{
                          display: 'flex', alignItems: 'center', padding: '24px 16px',
                  ...
                  <div style={{
                    ...
                    <div style={{
                      padding: '16px 24px', borderBottom: '1px solid #f1f5f9', backgroundColor: '#f8fafc',
                      display: 'flex', alignItems: 'center', justifyContent: 'space-between'
                    }}>
                      <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
                        <div style={{
                    ...
                    <div style={{
                      height: '360px', overflowY: 'auto', padding: '20px',
                    ...
                    <div style={{ padding: '16px 20px', borderTop: '1px solid #f1f5f9', backgroundColor: '#fff' }}>
                      {isClosed ? (
                        <div style={{
                          textAlign: 'center', padding: '12px', backgroundColor: '#f8fafc',
